     ...
     <!--<tr><td style="padding:5px"></td></tr> !-->
                ...
                <form action="?action=<?php echo $alm->id_producto > 0 ? 'actualizar' : 'registrar'; ?>" method="post" class="navbar-form navbar-default" >
                    ...
                    <!-- SI QUITAMOS EL TABLE ALIGN CENTER LOS CAMPOS QUEDAN A LO ALRGO !-->
                        ...
                        <tr>
                            <td >Producto</td>
                            <td><input type="text" class="form-control" name="nombre_producto" value="<?php echo $alm->__GET('nombre_producto'); ?>"  /></td>
                        </tr> 
                        </div>
                    ...
                    <div class="form-group">
                        <tr>
                            <td >Descripcion</td>
                            <td><input type="text" class="form-control" name="desc_producto" value="<?php echo $alm->__GET('desc_producto'); ?>"  /></td>
                        </tr>
                    ...
                    <div class="form-group">
                        <tr>
                            <td >fecha</td>
                            <td><input type="text" class="form-control" name="fecha_ingreso" value="<?php echo $alm->__GET('fecha_ingreso'); ?>"  /></td>
                        </tr>
